...
//实际使用的就是BeatBox的Fileedit版本，只不过添加了包名，主要想练习包的相关知识
//关于Eclipse中包的使用相对要方便一些，首先新建java project，然后右键新建package，直接输入任意包名即可
//关于包名，建议使用反向域名法，即com.xxx,xxx可为公司域名，完整到类名就是com.xxx.projects.Classname;类的首字母大写
...
public class BeatBoxPackage {
	...
	public static void main(String[] args){
		new BeatBoxPackage().buildGUI();//绘制图形界面
	}
